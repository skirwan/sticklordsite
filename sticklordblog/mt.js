...
var mtCookieDomain = ".sticklord.com";
var mtCookiePath = "/sticklordblog/";
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = '50bec2857d96c3cce8377c28a770d46c7f30b98a';
...
function mtSignIn() {
    ...
    if (is_preview) {
        if ( document['comments_form'] ) {
            ...
            url += '&return_url=http%3A%2F%2Fsticklord.com%2Fsticklordblog%2F';
        }
    } else {
